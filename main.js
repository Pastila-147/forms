...
class Popover {
  ...
  addPopover(element) {
    ...
    popoverText.textContent = "Вы уверены, что собаку еще не покормили?";
    ...
    console.log(left);
    popoverWrap.style.bottom = popoverWrap.offsetHeight + element.offsetHeight + 10 + "px";
    popoverWrap.style.left = left + (element.offsetWidth - popoverWrap.offsetWidth) / 2 - 8 + "px";
  }
  removePopover() {
